'use strict';
app.controller('AppCtrl', ['$rootScope', '$scope', '$state', '$swipe', '$translate', '$localStorage', '$window', '$document', '$timeout', 'SweetAlert', 'cfpLoadingBar', 'Fullscreen', 'USER_ROLES', 'AuthService', 'AUTH_EVENTS', '$http',
function ($rootScope, $scope, $state, $swipe, $translate, $localStorage, $window, $document, $timeout, SweetAlert, cfpLoadingBar, Fullscreen, USER_ROLES, AuthService, AUTH_EVENTS, $http) {
    ...
    $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
        ...
        if (toState.data.authorizedRoles && !AuthService.isAuthorized(authorizedRoles)) {
    ...
    var showNotAuthorized = function(){
        SweetAlert.swal("You are not authorized to view this page!");
    }
    ...
    $rootScope.$on(AUTH_EVENTS.notAuthenticated, clearCurrentUser);
    $rootScope.$on(AUTH_EVENTS.sessionTimeout, clearCurrentUser);
